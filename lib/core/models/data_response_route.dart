...
class DataResponseRoute {
    ...
    factory DataResponseRoute.fromJson(String str) => DataResponseRoute.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory DataResponseRoute.fromMap(Map<String, dynamic> json) => DataResponseRoute(
